        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BienesSolicitanteId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Automovil = table.Column<bool>(type: "bit", nullable: false),
                    PagoPendienteAutomovil = table.Column<float>(type: "real", nullable: false),
                    Casa = table.Column<bool>(type: "bit", nullable: false),
                    PagoPendienteCasa = table.Column<float>(type: "real", nullable: false),
                    Terreno = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DetalleDeudasId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TragetasCredito = table.Column<bool>(type: "bit", nullable: false),
                    PagoPendienteTargetas = table.Column<float>(type: "real", nullable: false),
                    CreditosLineaBlanca = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscapacidadDesc = table.Column<bool>(type: "bit", nullable: false),
                    TNA = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TiempoCredito = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCuota = table.Column<float>(type: "real", nullable: false),
                    EstadoCredito = table.Column<bool>(type: "bit", nullable: false),
                    SolicitudId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
